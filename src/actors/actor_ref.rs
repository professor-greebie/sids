...
/// let actor = ActorImpl::new(None, SampleActor, _rx);
...
/// let actor = BlockingActorImpl::new(None, SampleBlockingActor, _rx);
...
impl <MType: Send, Response: Send> BlockingActorRef <MType, Response> {
    pub fn new<T: Actor<MType, Response> + Send + 'static>(actor: BlockingActorImpl<T, MType, Response>, sender: std::sync::mpsc::Sender<Message<MType, Response>>, thread_monitor: &'static AtomicUsize, send_monitor: &'static AtomicUsize) -> Self {
